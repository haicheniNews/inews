...
public class ShowMenuLevelServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String fatherLevel=request.getParameter("father_level");
		DbCRUD db=new DbCRUD();
		String sql="SELECT * FROM menu WHERE menulevel=?;";
		List<Map<String,Object>> list=(ArrayList<Map<String,Object>>)db.query(sql, Integer.parseInt(fatherLevel));
